...
#    balance_now = upbit.get_balance("KRW")
    balance_now = 910000
    FnL = balance_now / balance_init - 1
#    post_message(chat_id,"원화잔고 : {:0,.0f}원".format(balance_now))
...
#                     post_message(chat_id=chat_id, text=t + " buy : " +str(buy_result))
#                upbit.get_
...
#                     post_message(chat_id=chat_id, text=t + " sell : " +str(sell_result))
#         time.sleep(1)
